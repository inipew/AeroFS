...
impl TransferService {
    ...
    pub async fn get_transfer(
        ...
        let job = TransferJob {
            ...
            execution_mode: r.try_get::<String, _>("execution_mode").ok().map(|s| crate::transfer::TransferExecutionMode::from_str(&s)).unwrap_or_default(),
            staging: r.try_get::<String, _>("staging").ok().map(|s| crate::transfer::TransferStaging::from_str(&s)).unwrap_or_default(),
