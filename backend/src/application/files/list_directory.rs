use crate::domain::{
    Actor, ConnectionId, DirectoryListing, FileKind, SortField, SortOrder, VfsPath,
};
...
impl ListDirectory {
    ...
    pub async fn execute(
        ...
        Ok(DirectoryListing {
            ...
            has_more,
            next_cursor: has_more.then(|| encode_cursor(seen)),
            entries,
        })
    }
}
...
fn sort_entries(entries: &mut [crate::domain::FileEntry], field: SortField, order: SortOrder) {
    entries.sort_by(|a, b| {
